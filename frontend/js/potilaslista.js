...
const getUsers = async () => {
  ...
  try {
    const url = `https://ptsdjahyvinvointiseurantasovellus.polandcentral.cloudapp.azure.com/api/users/patients/${userId}`;
...
const getPatientById = async (id) => {
  ...
  return await fetchData(`https://ptsdjahyvinvointiseurantasovellus.polandcentral.cloudapp.azure.com/api/users/${id}`, {
    headers: {
...
const getTSQByUserId = async (id) => {
  ...
  return await fetchData(`https://ptsdjahyvinvointiseurantasovellus.polandcentral.cloudapp.azure.com/api/tsq/user/${id}`, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
...
const getTSQAnswersByUserId = async (id) => {
  ...
  return await fetchData(
    `https://ptsdjahyvinvointiseurantasovellus.polandcentral.cloudapp.azure.com/api/tsq/${id}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
const getAllPatients = async () => {
  ...
  return await fetchData(
    "https://ptsdjahyvinvointiseurantasovellus.polandcentral.cloudapp.azure.com/api/users/patients",
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
const addPatientToDoctor = async (patientId) => {
  ...
  return await fetchData(
    `https://ptsdjahyvinvointiseurantasovellus.polandcentral.cloudapp.azure.com//api/users/patients/${patientId}/doctor`,
    {
      method: "PUT",
...
const getEntriesByUserId = async (id) => {
  ...
  return await fetchData(
    `https://ptsdjahyvinvointiseurantasovellus.polandcentral.cloudapp.azure.com/api/entries/user/${id}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
const getKubiosDataByUserId = async (id) => {
  ...
  return await fetchData(
    `https://ptsdjahyvinvointiseurantasovellus.polandcentral.cloudapp.azure.com/api/kubios/user-data/${id}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
